...
(function() {
    ...
    inventory.UniqueInventoryFull.itemInSlot = mf.uniqueInventorySlot;
    inventory.SmallCraftingAreaFull.itemInSlot = mf.uniqueInventorySlot;
    inventory.SmallCraftingAreaCrafted.itemInSlot = mf.uniqueInventorySlot;
    inventory.SmallCraftingArea.itemInSlot = mf.uniqueInventorySlot;
    inventory.Armor.itemInSlot = mf.uniqueInventorySlot;

    inventory.ChestFull.itemInSlot = mf.uniqueInventorySlot;
    inventory.ChestTop.itemInSlot = mf.uniqueInventorySlot;
    inventory.ChestBottom.itemInSlot = mf.uniqueInventorySlot;
    
    inventory.CraftingTableFull.itemInSlot = mf.uniqueInventorySlot;
    inventory.CraftingTableCrafted.itemInSlot = mf.uniqueInventorySlot;
    inventory.CraftingTable.itemInSlot = mf.uniqueInventorySlot;

    inventory.FurnaceFull.itemInSlot = mf.uniqueInventorySlot;
    inventory.FurnaceSmelted.itemInSlot = mf.uniqueInventorySlot;
    inventory.FurnaceSmelting.itemInSlot = mf.uniqueInventorySlot;
    inventory.FurnaceFuel.itemInSlot = mf.uniqueInventorySlot;

    inventory.Dispenser.itemInSlot = mf.uniqueInventorySlot;
     ...
     * @ returns {Object} mf.Item The item in slot 'slot', in the inventory inventory_type.
    */
    inventory.inventoryItem = function(slot,inventory_type) {
        ...
        if (slot < inventory_type.firstSlot || slot > inventory_type.lastSlot) {
            return undefined;
        }

        return inventory_type.itemInSlot(slot);
    };
   ...
   /**
    ...
    inventory.spaceLeft = function(item_type, inventory_type) {
        ...
        itemCount = 0;
        var current;
        for (var i = inventory_type.firstSlot; i < inventory_type.slotCount; i++) {
