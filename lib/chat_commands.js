...
(function() {
     ...
     * Don't use this
     */
    chat_commands.registerModule = function(module_name, module) {
    ...
    chat_commands.registerModule("chat_commands", chat_commands);
    ...
    chat_commands.registerCommand("set", set, 1, 2);
})();
