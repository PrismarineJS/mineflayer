...
ChatMessage.prototype.parse = function() {
	...
	if(typeof json.hoverEvent === 'object') {
		...
		if(this.hoverEvent.action === 'show_item') {
			this.hoverEvent.value = parseShowItemHoverEventValue(this.hoverEvent.value instanceof Array ? this.hoverEvent.value[0] : this.hoverEvent.value);
		}
	}
};
...
function testParseShowItemHoverEventValue() {
  ...
  assert.deepEqual(parseShowItemHoverEventValue('{key:value,}'), {key:"value"});
  assert.deepEqual(parseShowItemHoverEventValue('[0:v1,1:v2]'), ["v1","v2"]);
  assert.deepEqual(parseShowItemHoverEventValue('[0:"§6Last Killed: None",1:"§6Last Killer: None",2:"§6Rank: §aNovice-III",3:"§6§6Elo Rating: 1000",' +
    ']'),["§6Last Killed: None","§6Last Killer: None","§6Rank: §aNovice-III","§6§6Elo Rating: 1000"]);

  assert.deepEqual(parseShowItemHoverEventValue('{id:1s,Damage:0s,Count:1b,tag:{display:{Name:"§r§6Class' +
