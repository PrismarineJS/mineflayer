...
ChatMessage.prototype.parse = function() {
  ...
  if(typeof json.hoverEvent === 'object') {
    ...
    if(this.hoverEvent.action === 'show_item') {
      this.hoverEvent.value = mojangson.parse(this.hoverEvent.value instanceof Array ? this.hoverEvent.value[0] : (
      this.hoverEvent.value instanceof Object ? this.hoverEvent.value.text :
