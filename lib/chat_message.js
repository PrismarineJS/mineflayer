var mojangson=require('node-mojangson');
...
function ChatMessage(message) {
	// This should never be triggered, if it is check the function calling ChatMessage
	if (message == null) {console.log("Recieved null chat, skipping"); return ""}
