...
const { validateConfig } = require('./mod_loader_config')
const plugins = {
...
function createBot (options = {}) {
  ...
  // Validate and set mod loader configuration
  try {
    options.modLoader = validateConfig(options.modLoader || {})
  } catch (err) {
    throw new Error(`Invalid mod loader configuration: ${err.message}`)
  }
