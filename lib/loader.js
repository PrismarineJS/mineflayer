...
function createBot (options = {}) {
  ...
  function next () {
    ...
    const latestTestedVersionData = minecraftData.versionsByMinecraftVersion.pc[latestTestedVersion]
    if (versionData.version > latestTestedVersionData.version) {
      throw new Error(`Server version '${serverPingVersion}' is not supported. Latest supported version is '${latestTestedVersion}'.`)
    }
