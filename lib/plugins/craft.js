...
function inject (bot, { version }) {
  ...
  async function craft (recipe, craftingIterations, craftingTable) {
    assert.ok(recipe)
    craftingIterations = parseInt(craftingIterations ?? '1', 10)
    ...
    let remainingIterations = craftingIterations
