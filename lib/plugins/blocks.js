...
function inject (bot, { version }) {
  ...
  function addBlockEntity (nbtData) {
    ...
    if (blockEntity.id === 'minecraft:sign') {
      blockEntity.Text1 = new ChatMessage(JSON.parse(blockEntity.Text1))
      blockEntity.Text2 = new ChatMessage(JSON.parse(blockEntity.Text2))
      blockEntity.Text3 = new ChatMessage(JSON.parse(blockEntity.Text3))
      blockEntity.Text4 = new ChatMessage(JSON.parse(blockEntity.Text4))
