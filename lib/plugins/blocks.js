...
function inject (bot, { version, storageBuilder, hideErrors }) {
  ...
  bot.updateSign = (block, text, isFrontText = true) => {
    ...
    if (isFrontText === false && !bot.supportFeature('multiSidedSigns')) throw new Error(`The version of your bot does not support writing on the back of signs : ${bot.registry.minecraftVersion}`)
