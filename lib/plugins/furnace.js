...
function inject (bot, { version }) {
  const allFurnaceNames = ['furnace', 'lit_furnace', 'smoker', 'blast_furnace']

  function openFurnace (furnaceBlock) {
    assert.ok(allFurnaceNames.includes(furnaceBlock.name), `block '${furnaceBlock.name}' is not a known furnace block`)
