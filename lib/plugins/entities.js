...
function inject(bot,{version}) {
  var objects = require('minecraft-data')(version).objects;
  var mobs = require('minecraft-data')(version).mobs;
  var entitiesArray = require('minecraft-data')(version).entitiesArray;
