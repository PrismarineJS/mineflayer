...
function inject (bot) {
  ...
  // Note: spawn_entity_experience_orb packet was removed in 1.21.5
  // Experience orbs are now handled through the general spawn_entity packet
  // This handler is kept for backward compatibility with older versions
