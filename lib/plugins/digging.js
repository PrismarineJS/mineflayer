...
function inject (bot) {
  ...
  async function dig (block, forceLook, digFace) {
    ...
    // Recompute waitTime here: bot.digTime depends on movement state
    // (onGround, isInWater) which may have changed during the lookAt awaits.
