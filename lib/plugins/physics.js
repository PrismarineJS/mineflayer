...
function inject (bot, { physicsEnabled, maxCatchupTicks }) {
  ...
  function tickPhysics (now) {
    ...
    // this every client tick, including while chunks are unloaded, so it must
    // not depend on the early returns in runPhysicsTick.
    sendTickEnd()
  }
