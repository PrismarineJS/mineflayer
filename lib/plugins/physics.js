...
const { BotcraftPhysics, EntityPhysics, EPhysicsCtx, PhysicsWorldSettings, initSetup, PlayerState } = require('@nxg-org/mineflayer-physics-util')
...
function inject (bot, { physicsEnabled, maxCatchupTicks }) {
  ...
  function tickPhysics (now) {
    ...
    if (bot.physicsEnabled && shouldUsePhysics) {
      ...
      console.log(ectx.state.effects, bot.entity.effects)
      console.log("attributes:", bot.entity.attributes)
