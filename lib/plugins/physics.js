...
const WAIT_TIME_BEFORE_NEW_JUMP = 0.0  // good enough so that the player can actually see the bot landing and so the bot doesn't die from "fell from high ground"
