...
function inject (bot, options) {
  ...
  // It reads this on every configuration entry, so read bot.settings live rather than
  // snapshotting them, or a later setSettings would be undone by a reconfiguration.
  if (options.clientSettings == null) {
    Object.defineProperty(options, 'clientSettings', {
