...
function inject (bot, options) {
  ...
  // 1.20.2
  bot._client.prependListener('finish_configuration', () => {
    sendBrand()
    // TODO: prependListener can become on, and we can uncomment line below if handling and finalizing configuration will only happen inside game.js
