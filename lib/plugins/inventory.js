...
function inject (bot, { hideErrors }) {
  ...
  async function clickWindow (slot, mouseButton, mode, { expectedNewItem = null, updateAnvilManually = false } = {}) {
    ...
    const click = {
      ...
      inAnvil: bot.currentWindow.title === '{"translate":"container.repair"}' && bot.currentWindow.type === 'minecraft:anvil',
      expectedNewItem,
      updateAnvilManually // for anvil
    }
