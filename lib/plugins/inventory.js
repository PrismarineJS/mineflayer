...
function inject (bot, { version, hideErrors }) {
  ...
  bot._client.on('entity_status', (packet) => {
    ...
    bot.usingHeldItem = false
    console.log('set usingHeldItem to false because of entity status')
  })
  ...
  bot.on('heldItemChanged', () => {
    ...
    bot.usingHeldItem = false
    console.log('set usingHeldItem to false because of heldItemChanged')
  })
  ...
  bot._client.on('set_cooldown', () => {
    ...
    bot.usingHeldItem = false
    console.log('set usingHeldItem to false because of set_cooldown')
  })
  ...
  function activateItem (offHand = false) {
    console.log('set bot.usingHeldItem to true')
