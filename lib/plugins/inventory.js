...
const { sleep, createDoneTask, taskCompatibleWithRunningTask, withTimeout, tasks } = require('../promise_utils')
...
function inject (bot, { hideErrors }) {
  ...
  async function consume () {
    ...
    eatingTask = taskCompatibleWithRunningTask(tasks.inventory_consume)
