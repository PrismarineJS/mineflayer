...
function inject(bot) {
  ...
  function putSelectedItemBack(window, slot, cb) {
    ...
    function tryToJoin() {
      ...
      var item = window.findInventoryItem(window.selectedItem.type,
  ...
  function craft(recipe, count, craftingTable, cb) {
    ...
    function startClicking(window, w, h) {
      ...
      function incrementShapeIterator() {
        console.log("incrementShapeIterator", it.x, it.y);
        it.x += 1;
      ...
      function clickShape() {
        ...
        console.log("clickShape", "destSlot", destSlot, "ingredient", ingredient);
      ...
      function nextIngredientsClick() {
        ...
        console.log("nextIngredientsClick", "destSlot", destSlot, "ingredient", ingredient);
        if (!window.selectedItem || window.selectedItem.type !== ingredient.id ||
          (ingredient.metadata != null &&
           window.selectedItem.metadata !== ingredient.metadata))
        {
      ...
      function grabResult() {
        ...
        console.log("grabResult", "item", item);
      ...
      function updateOutShape() {
        console.log("updateOutShape", "outShape", recipe.outShape);
        if (! recipe.outShape) {
          closeTheWindow();
          return;
        }
  ...
  function clickWindow(slot, mouseButton, shift) {
    ...
    console.log("clickWindow", window.id, "slot", slot, "mouseButton", mouseButton, "shift", shift);
  ...
  bot.client.on(0x6a, function(packet) {
    ...
    function rejected() {
      console.log("rejected transaction:", "packet", packet, "click", click)
  ...
  bot.client.on(0x67, function(packet) {
    ...
    console.log("set slot event", "WindowId", packet.windowId, newItem);
  });
