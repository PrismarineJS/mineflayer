const CHAT_LIMIT_100_VERSIONS = ['1.8', '1.9', '1.10']

// Versions prior to 1.11 had a 100-character chat limit
function getChatLengthLimit (version) {
  if (CHAT_LIMIT_100_VERSIONS.indexOf(version) > -1) {
    return 100
  } else {
    return 256
  }
...
function inject (bot) {
  const CHAT_LENGTH_LIMIT = getChatLengthLimit(bot.version)
