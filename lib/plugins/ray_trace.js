    ...
    const players = Object.values(bot.players)
      .filter((player) => {
        return player.username !== bot.username && player.entity &&
                player.entity.position.distanceSquared(bot.entity.position) <= maxDistance ** 2
      }).sort((player1, player2) => player1.entity.position.distanceSquared(bot.entity.position) - player2.entity.position.distanceSquared(bot.entity.position))
