...
(function() {
     ...
     */
    items.nutrition_from_food = function(item_type) {
        return item_type_to_nutrition[item_type];
    };
    var item_type_to_nutrition = {};
    (function() {
        // http://www.minecraftwiki.net/wiki/Food
        item_type_to_nutrition[mf.ItemType.Bread] = 5;
        // no cake support yet :(
        item_type_to_nutrition[mf.ItemType.Cookie] = 1;
        item_type_to_nutrition[mf.ItemType.MelonSlice] = 2;
        item_type_to_nutrition[mf.ItemType.MushroomStew] = 8;
        item_type_to_nutrition[mf.ItemType.RawChicken] = 2;
        item_type_to_nutrition[mf.ItemType.CookedChicken] = 6;
        item_type_to_nutrition[mf.ItemType.RawBeef] = 3;
        item_type_to_nutrition[mf.ItemType.Steak] = 8;
        item_type_to_nutrition[mf.ItemType.RawPorkchop] = 3;
        item_type_to_nutrition[mf.ItemType.CookedPorkchop] = 8;
        item_type_to_nutrition[mf.ItemType.RawFish] = 2;
        item_type_to_nutrition[mf.ItemType.CookedFish] = 5;
        item_type_to_nutrition[mf.ItemType.Apple] = 4;
        item_type_to_nutrition[mf.ItemType.GoldenApple] = 10;
        item_type_to_nutrition[mf.ItemType.RottenFlesh] = 4;
        item_type_to_nutrition[mf.ItemType.SpiderEye] = 2;
    })();
