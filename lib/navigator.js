...
if (navigator === undefined) {
    navigator = function() {
        ...
        _public.navigateTo = function(end, callback, end_radius, give_up_threshold) {
            if (end_radius === undefined) {
                end_radius = 0.1;
            }
            ...
            var path = a_star.findPath({
                "start": start,
                "is_end_func": function(point) { return end.distanceTo(point) <= end_radius; },
