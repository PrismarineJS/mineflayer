...
if (navigator === undefined) {
    navigator = function() {
         ...
         *      give_up_threshold - passed on to the a_star library.
         *      path_found() - called when a path is found.
         *      cant_find() - called when a path can't be found.
         *      arrived_func() - called when the destination is reached.
         */
        _public.navigateTo = function(end, params) {
            ...
            var path = a_star.findPath({
                ...
                "give_up_threshold": params.give_up_threshold,
            });
            if (path === undefined) {
