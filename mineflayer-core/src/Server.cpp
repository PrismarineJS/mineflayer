...
const mineflayer_BlockFaceDirection Server::c_to_notch_face[] = {
    mineflayer_NoDirection,
...
mineflayer_BlockFaceDirection Server::toNotchianFace(mineflayer_BlockFaceDirection face) {
    Q_ASSERT(face >= -1 && face < 6);
    return (mineflayer_BlockFaceDirection) c_to_notch_face[face+1];
}
