    ...
    game(_game)
{
    ...
    Q_ASSERT(success);
    success = connect(game, SIGNAL(entitySpawned(QSharedPointer<Game::Entity>)), this, SLOT(entitySpawned(QSharedPointer<Game::Entity>)));
    Q_ASSERT(success);
    success = connect(game, SIGNAL(entityDespawned(QSharedPointer<Game::Entity>)), this, SLOT(entityDespawned(QSharedPointer<Game::Entity>)));
    Q_ASSERT(success);
    success = connect(game, SIGNAL(entityMoved(QSharedPointer<Game::Entity>)), this, SLOT(entityMoved(QSharedPointer<Game::Entity>)));
    Q_ASSERT(success);
    success = connect(game, SIGNAL(animation(QSharedPointer<Game::Entity>,Message::AnimationType)), this, SLOT(animation(QSharedPointer<Game::Entity>,Message::AnimationType)));
    Q_ASSERT(success);
    ...
    Q_ASSERT(success);
    success = connect(game, SIGNAL(stoppedDigging(Game::StoppedDiggingReason)), this, SLOT(stoppedDigging(Game::StoppedDiggingReason)));
    Q_ASSERT(success);
    success = connect(game, SIGNAL(loginStatusUpdated(Server::LoginStatus)), this, SLOT(loginStatusUpdated(Server::LoginStatus)));
    Q_ASSERT(success);
    success = connect(game, SIGNAL(windowOpened(Message::WindowType)), this, SLOT(windowOpened(Message::WindowType)));
    Q_ASSERT(success);
