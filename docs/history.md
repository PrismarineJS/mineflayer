...
## 4.39.0
* [test(trade): seed one stack per deposit so every transfer is a pick-up and place (#4030)](https://github.com/PrismarineJS/mineflayer/commit/b293d7f6204b42cf6148e1fffc35060425434e78) (thanks @u9g)
* [test: read rain state only after login in the isRaining internal test (#4054)](https://github.com/PrismarineJS/mineflayer/commit/8a2464aae994d331a14603aa8d4a8108cd5e1aab) (thanks @u9g)
* [fix: stop sending physics packets during the configuration phase on proxy server transfer (#3776) (#4005)](https://github.com/PrismarineJS/mineflayer/commit/f58a33ac7fc67f5ee6294c1b70b9884f08027f4c) (thanks @cryst6lkush)
* [settings: send particleStatus to the server (#4049)](https://github.com/PrismarineJS/mineflayer/commit/a5189e7445cee67098cbbafc26772af9f6148a5e) (thanks @u9g)
* [Expose cape URL in player skinData (#4046)](https://github.com/PrismarineJS/mineflayer/commit/0bc2bd9e7535e1c856e937e056294cacb50a15f9) (thanks @u9g)
* [test: detect harness bot disconnects instead of cascading failures (#4036)](https://github.com/PrismarineJS/mineflayer/commit/4708d288fac7da7d684585a6ed8230a34fc71bf4) (thanks @u9g)
* [test: await block and furnace updates instead of fixed sleeps (#4035)](https://github.com/PrismarineJS/mineflayer/commit/a9290184ee8e5c87b1362c428de67dff67a7b8d8) (thanks @u9g)
* [Flip isRaining on rain level zero-crossings, not only start/stop_raining (#4032)](https://github.com/PrismarineJS/mineflayer/commit/b800e766796e95fcab19a8fddafdb2a64a8ed857) (thanks @u9g)
* [test(trade): await the command block echoes instead of sleeping 2x500ms (#4029)](https://github.com/PrismarineJS/mineflayer/commit/0ac8891de71819d5b1cbd72afd229de4ae54b275) (thanks @u9g)
* [placeBlock: reject as soon as the server refuses the placement (#4024)](https://github.com/PrismarineJS/mineflayer/commit/cb03e5cc2778d86d95779d96bf7e5341f98a8dd7) (thanks @u9g)
* [inventory: sync the server's inventory bookkeeping after closing a window on pre-1.17 (#4023)](https://github.com/PrismarineJS/mineflayer/commit/97173bbf0617c515552dd49da157c2681e040e93) (thanks @u9g)
* [test: skip reset roundtrips that are provably no-ops (#3995)](https://github.com/PrismarineJS/mineflayer/commit/633eb40557adca067290c6c04e45ebf3cc0789d5) (thanks @u9g)
* [Speed up furnace external test by fast-forwarding CookTime (#3990)](https://github.com/PrismarineJS/mineflayer/commit/561491c2c6e58f2f1cb5f1f955529fc36a66caab) (thanks @u9g)
* [test(useChests): assert the click transitions instead of clicking randomly; fix rejected quick-move clicks on 1.12–1.16 (#3979)](https://github.com/PrismarineJS/mineflayer/commit/ab1d491394ce912caf6963e84e1b431bb4bc546d) (thanks @u9g)
* [test(trade): two trades per offer, and shift click in putAway (#3983)](https://github.com/PrismarineJS/mineflayer/commit/d68a3e0888fb089c63f8042d7c58ec5608410bfb) (thanks @u9g)
* [inventory: take half back instead of one right click per item in transfer (#3982)](https://github.com/PrismarineJS/mineflayer/commit/5483ef44baff33739d1233a7a9deb6c54e2109ef) (thanks @u9g)
* [ci: comment on PRs with tests that got slower instead of failing them (#4048)](https://github.com/PrismarineJS/mineflayer/commit/c07e457f79fd6faef17b195a47b798f27031e867) (thanks @u9g)
* [test(fishing): use the maximum viable Lure level per version (#3997)](https://github.com/PrismarineJS/mineflayer/commit/faa2e33e49f36980af66a1c29c3a81ff22fd3df1) (thanks @u9g)
* [ci: fail a PR if any test gets more than 1.5x slower than master (#4028)](https://github.com/PrismarineJS/mineflayer/commit/f603758e4228a7e61d1337526e6066e79308b976) (thanks @u9g)
* [fix: re-enable the book test and make writeBook/signBook work on 1.13+ (#4026)](https://github.com/PrismarineJS/mineflayer/commit/bbca46219bfe5449ad467b2aca842750eef0d6e7) (thanks @u9g)
* [test: await entity removal after /kill (#4025)](https://github.com/PrismarineJS/mineflayer/commit/783c944c665f3b49c6e8ee2aa99afee043aed45f) (thanks @u9g)
* [test(exampleBee): await the op confirmation instead of sleeping 2s (#3999)](https://github.com/PrismarineJS/mineflayer/commit/fd22614062860354191fbebc74ecc906f7ac6127) (thanks @u9g)
* [fix(inventory): don't let the trailing-sync path swallow a reused window id's early window_items (#4003)](https://github.com/PrismarineJS/mineflayer/commit/a02eb23df309c36d22c77287444e94d52660a366) (thanks @u9g)
* [test(bed): wait for chunks instead of sleeping a fixed 3s (#4011)](https://github.com/PrismarineJS/mineflayer/commit/ce48c4aeff8f1554a7321fe313d701541e6490e6) (thanks @u9g)
* [Emit blockEntityData and signOpen events and use them in the nether test (#4015)](https://github.com/PrismarineJS/mineflayer/commit/b141f7b9c447b6d5e7e99622154f890839518518) (thanks @u9g)
* [test: log the server seed and allow pinning it with LEVEL_SEED (#4022)](https://github.com/PrismarineJS/mineflayer/commit/a656b8afaf785473e2700d4039cc431c0639d95d) (thanks @u9g)
* [test: summon trade villager with the components-era count key on 1.20.5+ (#4009)](https://github.com/PrismarineJS/mineflayer/commit/48f5a513fa483812e9eb0657c47a343f3c0172c5) (thanks @u9g)
* [test: wait for conditions instead of sleeping in the example tests (#3984)](https://github.com/PrismarineJS/mineflayer/commit/5f5475e70d232e0d01b7a08dcabb6b97663c11c7) (thanks @u9g)
* [entities: apply spawn_entity velocity; test activateItem via the snowball it throws (#4020)](https://github.com/PrismarineJS/mineflayer/commit/5f44a5ba14303a671b2f0ccb789d429c93353141) (thanks @u9g)
* [Fix client-side inventory desyncs behind the 26.1 creative test failure (#3974)](https://github.com/PrismarineJS/mineflayer/commit/e93d2e8392187ffa811c6008bf4a0a243815b8e9) (thanks @u9g)
* [fix: don't let a failed external test poison the ones after it (#3975)](https://github.com/PrismarineJS/mineflayer/commit/2daa0efd0c9bd31a6fe25cfc3bb15975312df050) (thanks @u9g)
* [test(fishing): give the rod Lure III to cut the bite wait (#3989)](https://github.com/PrismarineJS/mineflayer/commit/3356973548dcd3b3223684dbfac598bfb0262221) (thanks @u9g)
