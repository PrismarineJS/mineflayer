...
Чтобы посмотреть актуальную информацию, Вы можете посмотреть оригинальную документацию [API](https://github.com/PrismarineJS/mineflayer/blob/master/docs/api.md).
