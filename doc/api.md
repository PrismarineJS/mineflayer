...
- [API](#api)
	- [Classes](#classes)
		...
		- [mineflayer.Entity](#mineflayerentity)
			...
			- [entity.equipment[5]](#entityequipment[5])
		...
		- [mineflayer.Furnace](#mineflayerfurnace)
			...
			- [furnace.takeInput([callback])](#furnacetakeinput[callback])
			- [furnace.takeFuel([callback])](#furnacetakefuel[callback])
			- [furnace.takeOutput([callback])](#furnacetakeoutput[callback])
		...
		- [mineflayer.EnchantmentTable](#mineflayerenchantmenttable)
			...
			- [enchantmentTable.takeTargetItem([callback])](#enchantmenttabletaketargetitem[callback])
