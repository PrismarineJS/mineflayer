...
client.on('ready', () => {
  ...
  channel = typeof client.channels.find === 'function'
    ? channel = client.channels.find(x => x.id === channel) // Support Discord 11.
    : channel = client.channels.cache.find(x => x.id === channel) // Discord.js 12
