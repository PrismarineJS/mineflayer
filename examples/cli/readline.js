 ...
 * Using this, we can make a simple terminal-to-in-game chat interface
 *
...
const rl = readline.createInterface({ // create our readline interface with our console as input and output
  input: process.stdin,
...
bot.on('message', (message) => {
  readline.moveCursor(process.stdout, -2, 0) // move the cursor two places left (because of the input arrow)
...
rl.on('line', (line) => {
  ...
  bot.chat(line.toString()) // send the line we entered to in-game chat
})
